...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["gundo.vim"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/gundo.vim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["splitjoin.vim"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/splitjoin.vim",
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/vim-gitgutter",
  ...
  ["vim-obsession"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/vim-obsession",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/vim-surround",
  ...
  ["vim-unimpaired"] = {
    loaded = true,
    path = "/home/masayuki/.local/share/nvim/site/pack/packer/start/vim-unimpaired",
